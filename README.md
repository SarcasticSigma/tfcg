...
# [TerraFirmaGreg-0.9.11](https://www.curseforge.com/minecraft/modpacks/terrafirmagreg-modern) on Curseforge
<!-- toc -->
...
The docker on the first run will download the same version as tagged `TerraFirmaGreg-0.9.11` and install it.  This can take a while as the Forge installer can take a bit to complete.  You can watch the logs and it will eventually finish.
